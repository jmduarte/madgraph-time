...
C     
C     Process: g g > g g WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 2
      ...
      CALL VVV1P0_1(W(1,1),W(1,3),GC_10,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,2),W(1,4),W(1,5),GC_10,AMP(5))
      CALL VVV1P0_1(W(1,1),W(1,4),GC_10,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,2),W(1,3),W(1,5),GC_10,AMP(6))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+2D0*(+AMP(3)-AMP(1)-AMP(4)+AMP(6))
      JAMP(2,1)=+2D0*(+AMP(1)+AMP(2)+AMP(4)+AMP(5))
      JAMP(3,1)=+2D0*(-AMP(3)-AMP(2)-AMP(5)-AMP(6))
      JAMP(4,1)=+2D0*(+AMP(1)+AMP(2)+AMP(4)+AMP(5))
      JAMP(5,1)=+2D0*(-AMP(3)-AMP(2)-AMP(5)-AMP(6))
      JAMP(6,1)=+2D0*(+AMP(3)-AMP(1)-AMP(4)+AMP(6))
