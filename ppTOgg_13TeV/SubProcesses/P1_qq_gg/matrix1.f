...
C     
C     Process: u u~ > g g WEIGHTED<=2 @1
C     Process: c c~ > g g WEIGHTED<=2 @1
C     Process: d d~ > g g WEIGHTED<=2 @1
C     Process: s s~ > g g WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,3),W(1,4),W(1,5),GC_10,AMP(1))
      CALL FFV1_2(W(1,1),W(1,3),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,2),W(1,4),GC_11,AMP(2))
      CALL FFV1_2(W(1,1),W(1,4),GC_11,ZERO,ZERO,W(1,5))
